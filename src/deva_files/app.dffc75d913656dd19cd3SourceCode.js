    ...
    n.n = e => {
        ...
        new class {
            ...
            renderChatText() {
                ...
                e.type = "text", e.placeholder = "请输入内容！", e.value = this.chatTextValue, e.addEventListener("input", (e => {
                    ...
                    }), this.send(this.chatTextValue), this.chatTextValue = null, e.value = this.chatTextValue) : alert("请输入内容！"))
                }));
                const t = document.createElement("div");
                return t.classList.add("chat-user-content-send"), t.innerHTML = "发送", t.addEventListener("click", (() => {
            ...
            renderChatRecord() {
                ...
                i.classList.add("chat-user-content-record"), i.id = "btnStartVoiceInput", i.innerHTML = "点击开始语音输入";
                const s = document.createElement("div");
                return s.classList.add("chat-user-content-record-cancel"), s.innerHTML = "取消", s.addEventListener("click", (n => {
                    t = !1, this.stopRecording(e), i.innerHTML = "点击开始语音输入", s.style.display = "none"
                })), i.addEventListener("click", (a => {
                    this.isRecord = !this.isRecord, this.isRecord ? (i.id = "btnStopVoiceInput", i.innerHTML = "点击停止录音并发送", s.style.display = "block", n = "", e = this.asr(), e.startContinuousRecognitionAsync(), e.recognized = (e, t) => {
                        t.result.text && (console.log("recognized", t.result.text), n += t.result.text)
                    }, e.sessionStopped = (e, i) => {
                        t && n && (n = n.trim(), "." != n[n.length - 1] && "什么" != n[n.length - 1] || (n = n.slice(0, n.length - 1)), console.log("send text", n), this.chat.add({
                            type: "user",
                            content: n
                        }), this.send(n))
                    }) : (i.innerHTML = "点击开始语音输入", i.id = "btnStartVoiceInput", s.style.display = "none", t = !0, this.stopRecording(e))
                })), [i, s]
            }
            asr() {
                const {
            ...
            renderUnity() {
                ...
                e.width = "100%", e.height = "100%", e.style.border = "none", e.src = `https://pngkg.blob.core.windows.net/hprecording/DEVA4/%E8%99%9A%E6%8B%9F%E4%B8%BB%E6%92%AD_files/index.html`, e.id = "unity", this.avatar && document.getElementById("nn-container").appendChild(e)
            }
            audioHandler(e, t) {
